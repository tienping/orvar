export const spinAndWin = {
    ...
    data: {
        id: 1, // game id
        title: 'Perfect Pair', // game title
        description: 'Spin and Win', // game description
        type: 'mix-and-match', // game type [mix-and-match/spin-and-win]
        ...
        config: { // json
            menu: {
                ...
                game_expired_image: 'game_expired_image_imageUr',
            },
            game: {
                colors: [
                    '#000000',
        ...
        status: true, // game status
        created_at: '2019-11-04T02:21:15.069Z', // created time
        created_by: 513125, // creator id
        updated_at: '2019-11-05T09:17:32.000Z', // update time
        updated_by: 513125, // updater id
    },
};
...
export const perfectPair = {
    ...
    data: {
        ...
        end_date: '2019-01-01 23:59:59', // end date game to play
        token_currency: null,
        token_charge: 0, // charge per game
        rule_id: 1,
        rewards: {
            data: null,
        },
...
export const videoShow = {
    ...
    data: {
        id: 1, // game id
        title: 'Video Show', // game title
        description: 'xxxx', // game description
        type: 'video-show', // game type [mix-and-match/spin-and-win]
        start_date: '2019-01-01 00:00:00', // start date game to play
        end_date: '2019-01-01 23:59:59', // end date game to play
        token_currency: { // token currency to play game (get from gami:system_service:system_config)
            id: 6, // system_config id
